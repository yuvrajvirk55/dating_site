...
<div id="myNav_places" class="overlay_places">
  ...
  <div class="overlay-content_places">
    <a class="aa" style="font-size:80px !important;">Password Change</a>
      ...
      <a class="aa"><div align="center"><asp:TextBox ID="register_cpassword" runat="server" BackColor="#E1E1E1"  Width="450px" class="input100" TextMode="Password"  placeholder="Comfirm Password"></asp:TextBox></div></a>
